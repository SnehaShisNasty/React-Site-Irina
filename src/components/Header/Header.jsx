...
const Header = () => {
  ...
  if (search !== '') {
    ...
    const filtered = items.filter(item => {
      ...
      const translatedName = t(`services.${itemName}.name`).toLocaleLowerCase(language);
      const translatedNameFind = translatedName.includes(search.toLocaleLowerCase(language));
